...
describe('most likes', () => {
  ...
  test('of empty list is undefined for author and likes', () => {
    assert.deepStrictEqual(listHelper.mostLikes([]), {author: undefined, likes: undefined})
  })

  test('when list has only one blog, equals author of that blog and likes of that blog', () => {
